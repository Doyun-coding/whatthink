    ...
    <body>
     ...
     crossorigin="anonymous"></script>
        ...
        <section class="mainsection">
            ...
            <?php
                if (isset($user_nick)) {
                    $sql1 = "select boardnum from dp_select where boardnum = 21 and user_nick = '$user_nick'";
                    $res1 = mysqli_query($db, $sql1);
                    $row1 = mysqli_fetch_row($res1);
                    
                    if($row1[0] == 21) { ?>                       
                        <?php
                        $sql1_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 21";
                        $res1_choice = mysqli_query($db, $sql1_choice);
                        $row1_choice = mysqli_fetch_row($res1_choice);
                        $sql1_red_num = "select * from dp_select where boardnum = 21 and choice = 'red'";
                        $sql1_blue_num = "select * from dp_select where boardnum = 21 and choice = 'blue'";
                        ...
                        if ($row1_choice[0] == "red") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="21">
                                    <strong><span style="color: crimson; text-decoration:underline; cursor: default;">파란색 포카칩 <?php echo $red1_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply1_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="초록색 포카칩 <?php echo $blue1_num; ?>"></input></strong>
                                </div>
                            </form>
                        ...
                        elseif ($row1_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="21">
                                    <strong><input class = "change_left" type="submit" name="changetored" value="파란색 포카칩 <?php echo $red1_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply1_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 초록색 포카칩 <?php echo $blue1_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        <?php } ?>
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="21">
                                    <strong><input class="red" type="submit" name="dp_red" value="파란색 포카칩"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="초록색 포카칩"></strong>
                                </div>
                            </div>
                        </form>
                ...
                <div class="boardnum_reply" id="reply1_screen" style="display: none;" >
                    <fieldset id="reply1" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply_iframe">
                            <input type="hidden" name="reply_boardnum" value="21">
                            <input type="hidden" name="reply_choice" value="<?php echo $row1_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep21">
                        ...
                        <div id="21">
                            <div id="rep21">
                            <?php // 댓글 본문
                                $sql1_reply = "SELECT * FROM reply WHERE reply_boardnum = '21' ORDER BY reply.reply_no DESC LIMIT 100";
                                ...
                                <!-- <script type="text/javascript">
                                    ...
                                    reply1.addEventListener("scroll", myPageScroll);

                                    function myPageScroll() {
                                        var myScrollTop = reply1.scrollTop;
                                        var myScrollHeight = reply1.scrollHeight;
                                        var diff = myScrollHeight - myScrollTop;
                                        var height = reply1.clientHeight;
                                        if(diff == height) {
                                            $more1 = 1;
                                        }
                ...
                <?php
                if (isset($user_nick)) {
                    $sql2 = "select boardnum from dp_select where boardnum = 22 and user_nick = '$user_nick'";
                    $res2 = mysqli_query($db, $sql2);
                    $row2 = mysqli_fetch_row($res2);
                    
                    if ($row2[0] == 22) { ?>                       
                        <?php
                        $sql2_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 22";
                        $res2_choice = mysqli_query($db, $sql2_choice);
                        $row2_choice = mysqli_fetch_row($res2_choice);
                        $sql2_red_num = "select * from dp_select where boardnum = 22 and choice = 'red'";
                        $sql2_blue_num = "select * from dp_select where boardnum = 22 and choice = 'blue'";
                        ...
                        if ($row2_choice[0] == "red") { ?>
                            <h4 class="dpt"> 5억년 버튼이 실제로 존재한다면 누르시겠습니까? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="22">
                                    <strong><span style="color: crimson; text-decoration:underline;">누른다 <?php echo $red2_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply2_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class = "change_right" type="submit" name="changetoblue" value="누르지 않는다 <?php echo $blue2_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row2_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="22">
                                    <strong><input class="change_left" type="submit" name="changetored" value="누른다 <?php echo $red2_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply2_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 누르지 않는다 <?php echo $blue2_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="22">
                                    <strong><input class="red" type="submit" name="dp_red" value="누른다"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="누르지 않는다"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply2_screen" style="display: none;" >
                    <fieldset id="reply2" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply2_iframe">
                            <input type="hidden" name="reply_boardnum" value="22">
                            <input type="hidden" name="reply_choice" value="<?php echo $row2_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep22">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="22">
                            <div id="rep22">
                            <?php // 댓글 본문
                                $sql2_reply = "SELECT * FROM reply WHERE reply_boardnum = '22' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql3 = "select boardnum from dp_select where boardnum =23 and user_nick = '$user_nick'";
                    $res3 = mysqli_query($db, $sql3);
                    $row3 = mysqli_fetch_row($res3);
                    
                    if ($row3[0] == 23) { ?>                       
                        <?php
                        $sql3_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 23";
                        $res3_choice = mysqli_query($db, $sql3_choice);
                        $row3_choice = mysqli_fetch_row($res3_choice);
                        $sql3_red_num = "select * from dp_select where boardnum = 23 and choice = 'red'";
                        $sql3_blue_num = "select * from dp_select where boardnum = 23 and choice = 'blue'";
                        ...
                        if ($row3_choice[0] == "red") { ?>
                            <h4 class="dpt"> 같은 조건 동일한 피지컬을 갖은 사람 둘이 싸운다면 칼 VS 야구 방망이 </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="23">
                                    <strong><span style="color: crimson; text-decoration:underline;">칼 <?php echo $red3_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply3_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="야구 방망이 <?php echo $blue3_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row3_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="23">
                                    <strong><input class="change_left" type="submit" name="changetored" value="칼 <?php echo $red3_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply3_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 야구 방망이 <?php echo $blue3_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="23">
                                    <strong><input class="red" type="submit" name="dp_red" value="칼"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="야구 방망이"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply3_screen" style="display: none;" >
                    <fieldset id="reply3" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply3_iframe">
                            <input type="hidden" name="reply_boardnum" value="23">
                            <input type="hidden" name="reply_choice" value="<?php echo $row3_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep23">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="23">
                            <div id="rep23">
                            <?php // 댓글 본문
                                $sql3_reply = "SELECT * FROM reply WHERE reply_boardnum = '23' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql4 = "select boardnum from dp_select where boardnum = 24 and user_nick = '$user_nick'";
                    $res4 = mysqli_query($db, $sql4);
                    $row4 = mysqli_fetch_row($res4);
                    
                    if ($row4[0] == 24) { ?>                       
                        <?php
                        $sql4_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 24";
                        $res4_choice = mysqli_query($db, $sql4_choice);
                        $row4_choice = mysqli_fetch_row($res4_choice);
                        $sql4_red_num = "select * from dp_select where boardnum = 24 and choice = 'red'";
                        $sql4_blue_num = "select * from dp_select where boardnum = 24 and choice = 'blue'";
                        ...
                        if ($row4_choice[0] == "red") { ?>
                            <h4 class="dpt"> AI의 빠른 발전에 대해 긍정적이다? 부정적이다? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="24">
                                    <strong><span style="color: crimson; text-decoration:underline;">긍정적이다 <?php echo $red4_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply4_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="부정적이다 <?php echo $blue4_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row4_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="24">
                                    <strong><input class="change_left" type="submit" name="changetored" value="긍정적이다 <?php echo $red4_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply4_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 부정적이다 <?php echo $blue4_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="24">
                                    <strong><input class="red" type="submit" name="dp_red" value="긍정적이다"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="부정적이다"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply4_screen" style="display: none;" >
                    <fieldset id="reply4" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply4_iframe">
                            <input type="hidden" name="reply_boardnum" value="24">
                            <input type="hidden" name="reply_choice" value="<?php echo $row4_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep24">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="24">
                            <div id="rep24">
                            <?php // 댓글 본문
                                $sql4_reply = "SELECT * FROM reply WHERE reply_boardnum = '24' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql5 = "select boardnum from dp_select where boardnum = 25 and user_nick = '$user_nick'";
                    $res5 = mysqli_query($db, $sql5);
                    $row5 = mysqli_fetch_row($res5);
                    
                    if ($row5[0] == 25) { ?>                       
                        <?php
                        $sql5_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 25";
                        $res5_choice = mysqli_query($db, $sql5_choice);
                        $row5_choice = mysqli_fetch_row($res5_choice);
                        $sql5_red_num = "select * from dp_select where boardnum = 25 and choice = 'red'";
                        $sql5_blue_num = "select * from dp_select where boardnum = 25 and choice = 'blue'";
                        ...
                        if ($row5_choice[0] == "red") { ?>
                            <h4 class="dpt"> MBTI 검사는 유사과학일까? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="25">
                                    <strong><span style="color: crimson; text-decoration:underline;">유사과학이다 <?php echo $red5_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply5_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="아니다 <?php echo $blue5_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row5_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="25">
                                    <strong><input class="change_left" type="submit" name="changetored" value="유사과학이다 <?php echo $red5_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply5_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 아니다 <?php echo $blue5_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="25">
                                    <strong><input class="red" type="submit" name="dp_red" value="유사과학이다"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="아니다"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply5_screen" style="display: none;" >
                    <fieldset id="reply5" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply5_iframe">
                            <input type="hidden" name="reply_boardnum" value="25">
                            <input type="hidden" name="reply_choice" value="<?php echo $row5_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep25">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="25">
                            <div id="rep25">
                            <?php // 댓글 본문
                                $sql5_reply = "SELECT * FROM reply WHERE reply_boardnum = '25' ORDER BY reply.reply_no DESC LIMIT 100";
        ...
        <div class="page">
            <ul class="pagination modal">
                ...
                <li><a href="http://www.whatthinkkr.com/whatthink_main4.php" class="num">4</a></li>
                <li><a href="http://www.whatthinkkr.com/whatthink_main5.php" class="active num">5</a></li>
