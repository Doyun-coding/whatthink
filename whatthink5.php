     ...
     crossorigin="anonymous"></script>
        ...
        <section class="mainsection">
            <div>
                <div id="dp1">
                    ...
                    <div class="ngraph">
                        <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                            <span class="result_choice">파란색 포카칩</span>
                            <span class="result_vote" id="result1_vote">결과보기</span>
                            <span class="result_choice">초록색 포카칩</span>
                        </div>
                    </div>
                </div>
                ...
                <div id="result1_dp" style="display: none;">
                    <?php
                    $res1_choice = mysqli_query($db, "select choice from dp_select where boardnum = 21");
                    $row1_choice = mysqli_fetch_row($res1_choice);
                    $res1_red_num = mysqli_query($db, "select * from dp_select where boardnum = 21 and choice = 'red'");
                    $res1_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 21 and choice = 'blue'");
                    ...
                    if ($red1_num >= $blue1_num) { ?>
                        ...
                        <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                            <strong><span class="result_choice_red" style="color: crimson;">파란색 포카칩 <?php echo $red1_num; ?> </span></strong> 
                            <strong><span class="opinion" id="reply1_button" type="button" style="text-align: center;">의견</span></strong>
                            <strong><span class="result_choice_blue" style="color: deepskyblue;">초록색 포카칩 <?php echo $blue1_num; ?></span></strong>
                        </div>
                    <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp2">
                        <h4> 5억년 버튼이 실제로 존재한다면 누르시겠습니까? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">누른다</span>
                                <span class="result_vote" id="result2_vote">결과보기</span>
                                <span class="result_choice">누르지 않는다</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result2_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res2_choice = mysqli_query($db, "select choice from dp_select where boardnum = 22");
                        $row2_choice = mysqli_fetch_row($res2_choice);
                        $res2_red_num = mysqli_query($db, "select * from dp_select where boardnum = 22 and choice = 'red'");
                        $res2_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 22 and choice = 'blue'");
                        ...
                        if ($red2_num >= $blue2_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">누른다 <?php echo $red2_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply2_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">누르지 않는다 <?php echo $blue2_num; ?></span></strong>
                            </div>
                        <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp3">
                        <h4> 같은 조건 동일한 피지컬을 갖은 사람 둘이 싸운다면 칼 VS 야구 방망이 </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">칼</span>
                                <span class="result_vote" id="result3_vote">결과보기</span>
                                <span class="result_choice">야구 방망이</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result3_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res3_choice = mysqli_query($db, "select choice from dp_select where boardnum = 23");
                        $row3_choice = mysqli_fetch_row($res3_choice);
                        $res3_red_num = mysqli_query($db, "select * from dp_select where boardnum = 23 and choice = 'red'");
                        $res3_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 23 and choice = 'blue'");
                        ...
                        if ($red3_num >= $blue3_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">칼<?php echo $red3_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply3_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">야구 방망이 <?php echo $blue3_num; ?></span></strong>
                            </div>
                        <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp4">
                        <h4> AI의 빠른 발전에 대해 긍정적이다? 부정적이다? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">긍정적이다</span>
                                <span class="result_vote" id="result4_vote">결과보기</span>
                                <span class="result_choice">부정적이다</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result4_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res4_choice = mysqli_query($db, "select choice from dp_select where boardnum = 24");
                        $row4_choice = mysqli_fetch_row($res4_choice);
                        $res4_red_num = mysqli_query($db, "select * from dp_select where boardnum = 24 and choice = 'red'");
                        $res4_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 24 and choice = 'blue'");
                        ...
                        if ($red4_num >= $blue4_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">긍정적이다 <?php echo $red4_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply4_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">부정적이다 <?php echo $blue4_num; ?></span></strong>
                            </div>
                        <?php } 
                        elseif ($blue4_num >= $red4_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="change_left" type="submit" name="changetored">긍정적이다 <?php echo $red4_num; ?></span></strong> 
                                <strong><span class="opinion" id="reply4_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;"> 부정적이다 <?php echo $blue4_num; ?> </span></strong>
                            </div>
                        <?php } ?>
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp5">
                        <h4> MBTI 검사는 유사과학일까? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice" >유사과학이다</span>
                                <span class="result_vote" id="result5_vote">결과보기</span>
                                <span class="result_choice">아니다</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result5_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res5_choice = mysqli_query($db, "select choice from dp_select where boardnum = 25");
                        $row5_choice = mysqli_fetch_row($res5_choice);
                        $res5_red_num = mysqli_query($db, "select * from dp_select where boardnum = 25 and choice = 'red'");
                        $res5_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 25 and choice = 'blue'");
                        ...
                        if ($red5_num >= $blue5_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">유사과학이다 <?php echo $red5_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply5_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">아니다 <?php echo $blue5_num; ?></span></strong>
                            </div>
                        <?php } 
        ...
        <div class="page">
            <ul class="pagination modal">
                ...
                <li><a href="http://www.whatthinkkr.com/whatthink5.php" class="active num">5</a></li>
