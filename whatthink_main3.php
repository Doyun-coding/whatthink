    ...
    <body>
     ...
     crossorigin="anonymous"></script>
        ...
        <section class="mainsection">
            ...
            <?php
                if (isset($user_nick)) {
                    $sql1 = "select boardnum from dp_select where boardnum = 11 and user_nick = '$user_nick'";
                    $res1 = mysqli_query($db, $sql1);
                    $row1 = mysqli_fetch_row($res1);
                    
                    if($row1[0] == 11) { ?>                       
                        <?php
                        $sql1_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 11";
                        $res1_choice = mysqli_query($db, $sql1_choice);
                        $row1_choice = mysqli_fetch_row($res1_choice);
                        $sql1_red_num = "select * from dp_select where boardnum = 11 and choice = 'red'";
                        $sql1_blue_num = "select * from dp_select where boardnum = 11 and choice = 'blue'";
                        ...
                        if ($row1_choice[0] == "red") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="11">
                                    <strong><span style="color: crimson; text-decoration:underline; cursor: default;">존재한다 <?php echo $red1_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply1_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="없다 <?php echo $blue1_num; ?>"></input></strong>
                                </div>
                            </form>
                        ...
                        elseif ($row1_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="11">
                                    <strong><input class = "change_left" type="submit" name="changetored" value="존재한다 <?php echo $red1_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply1_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 없다 <?php echo $blue1_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        <?php } ?>
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="11">
                                    <strong><input class="red" type="submit" name="dp_red" value="존재한다"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="없다"></strong>
                                </div>
                            </div>
                        </form>
                ...
                <div class="boardnum_reply" id="reply1_screen" style="display: none;" >
                    <fieldset id="reply11" class="reply" style="overflow: auto;">
                        ...
                        <div id="11">
                            <div id="rep11">
                            <?php // 댓글 본문
                                $sql1_reply = "SELECT * FROM reply WHERE reply_boardnum = '11' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql2 = "select boardnum from dp_select where boardnum = 12 and user_nick = '$user_nick'";
                    $res2 = mysqli_query($db, $sql2);
                    $row2 = mysqli_fetch_row($res2);
                    
                    if ($row2[0] == 12) { ?>                       
                        <?php
                        $sql2_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 12";
                        $res2_choice = mysqli_query($db, $sql2_choice);
                        $row2_choice = mysqli_fetch_row($res2_choice);
                        $sql2_red_num = "select * from dp_select where boardnum = 12 and choice = 'red'";
                        $sql2_blue_num = "select * from dp_select where boardnum = 12 and choice = 'blue'";
                        ...
                        if ($row2_choice[0] == "red") { ?>
                            <h4 class="dpt"> 핸드폰은 갤럭시다? 아이폰이다? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="12">
                                    <strong><span style="color: crimson; text-decoration:underline;">갤럭시 <?php echo $red2_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply2_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class = "change_right" type="submit" name="changetoblue" value="아이폰 <?php echo $blue2_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row2_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="12">
                                    <strong><input class="change_left" type="submit" name="changetored" value="갤럭시 <?php echo $red2_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply2_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 아이폰 <?php echo $blue2_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="12">
                                    <strong><input class="red" type="submit" name="dp_red" value="갤럭시"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="아이폰"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply2_screen" style="display: none;" >
                    <fieldset id="reply2" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply2_iframe">
                            <input type="hidden" name="reply_boardnum" value="12">
                            <input type="hidden" name="reply_choice" value="<?php echo $row2_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep12">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="12">
                            <div id="rep12">
                            <?php // 댓글 본문
                                $sql2_reply = "SELECT * FROM reply WHERE reply_boardnum = '12' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql3 = "select boardnum from dp_select where boardnum = 13 and user_nick = '$user_nick'";
                    $res3 = mysqli_query($db, $sql3);
                    $row3 = mysqli_fetch_row($res3);
                    
                    if ($row3[0] == 13) { ?>                       
                        <?php
                        $sql3_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 13";
                        $res3_choice = mysqli_query($db, $sql3_choice);
                        $row3_choice = mysqli_fetch_row($res3_choice);
                        $sql3_red_num = "select * from dp_select where boardnum = 13 and choice = 'red'";
                        $sql3_blue_num = "select * from dp_select where boardnum = 13 and choice = 'blue'";
                        ...
                        if ($row3_choice[0] == "red") { ?>
                            <h4 class="dpt"> UFO, 외계인은 존재하는가? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="13">
                                    <strong><span style="color: crimson; text-decoration:underline;">존재한다 <?php echo $red3_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply3_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="없다 <?php echo $blue3_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row3_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="13">
                                    <strong><input class="change_left" type="submit" name="changetored" value="존재한다 <?php echo $red3_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply3_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 없다 <?php echo $blue3_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply3_screen" style="display: none;" >
                    <fieldset id="reply3" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply3_iframe">
                            <input type="hidden" name="reply_boardnum" value="13">
                            <input type="hidden" name="reply_choice" value="<?php echo $row3_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep13">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="13">
                            <div id="rep13">
                            <?php // 댓글 본문
                                $sql3_reply = "SELECT * FROM reply WHERE reply_boardnum = '13' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql4 = "select boardnum from dp_select where boardnum = 14 and user_nick = '$user_nick'";
                    $res4 = mysqli_query($db, $sql4);
                    $row4 = mysqli_fetch_row($res4);
                    
                    if ($row4[0] == 14) { ?>                       
                        <?php
                        $sql4_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 14";
                        $res4_choice = mysqli_query($db, $sql4_choice);
                        $row4_choice = mysqli_fetch_row($res4_choice);
                        $sql4_red_num = "select * from dp_select where boardnum = 14 and choice = 'red'";
                        $sql4_blue_num = "select * from dp_select where boardnum = 14 and choice = 'blue'";
                        ...
                        if ($row4_choice[0] == "red") { ?>
                            <h4 class="dpt"> 음바페 VS 홀란드 음란대전 누가 더 우세한가? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="14">
                                    <strong><span style="color: crimson; text-decoration:underline;">음바페 <?php echo $red4_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply4_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="홀란드 <?php echo $blue4_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row4_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="14">
                                    <strong><input class="change_left" type="submit" name="changetored" value="음바페 <?php echo $red4_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply4_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 홀란드 <?php echo $blue4_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="14">
                                    <strong><input class="red" type="submit" name="dp_red" value="음바페"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="홀란드"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply4_screen" style="display: none;" >
                    <fieldset id="reply4" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply4_iframe">
                            <input type="hidden" name="reply_boardnum" value="14">
                            <input type="hidden" name="reply_choice" value="<?php echo $row4_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep14">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="14">
                            <div id="rep14">
                            <?php // 댓글 본문
                                $sql4_reply = "SELECT * FROM reply WHERE reply_boardnum = '14' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql5 = "select boardnum from dp_select where boardnum = 15 and user_nick = '$user_nick'";
                    $res5 = mysqli_query($db, $sql5);
                    $row5 = mysqli_fetch_row($res5);
                    
                    if ($row5[0] == 15) { ?>                       
                        <?php
                        $sql5_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 15";
                        $res5_choice = mysqli_query($db, $sql5_choice);
                        $row5_choice = mysqli_fetch_row($res5_choice);
                        $sql5_red_num = "select * from dp_select where boardnum = 15 and choice = 'red'";
                        $sql5_blue_num = "select * from dp_select where boardnum = 15 and choice = 'blue'";
                        ...
                        if ($row5_choice[0] == "red") { ?>
                            <h4 class="dpt"> 요즘 대세 SNS는 인스타인가 틱톡인가? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="15">
                                    <strong><span style="color: crimson; text-decoration:underline;">인스타 <?php echo $red5_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply5_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="틱톡 <?php echo $blue5_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row5_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="15">
                                    <strong><input class="change_left" type="submit" name="changetored" value="인스타 <?php echo $red5_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply5_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 틱톡 <?php echo $blue5_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="15">
                                    <strong><input class="red" type="submit" name="dp_red" value="인스타"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="틱톡"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply5_screen" style="display: none;" >
                    <fieldset id="reply5" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply5_iframe">
                            <input type="hidden" name="reply_boardnum" value="15">
                            <input type="hidden" name="reply_choice" value="<?php echo $row5_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep15">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="15">
                            <div id="rep15">
                            <?php // 댓글 본문
                                $sql5_reply = "SELECT * FROM reply WHERE reply_boardnum = '15' ORDER BY reply.reply_no DESC LIMIT 100";
        ...
        <div class="page">
            <ul class="pagination modal">
                ...
                <li><a href="http://www.whatthinkkr.com/whatthink_main3.php" class="active num">3</a></li>
