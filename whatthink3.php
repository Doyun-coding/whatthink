     ...
     crossorigin="anonymous"></script>
        ...
        <section class="mainsection">
            <div>
                <div id="dp1">
                    ...
                    <div class="ngraph">
                        <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                            <span class="result_choice">존재한다</span>
                            <span class="result_vote" id="result1_vote">결과보기</span>
                            <span class="result_choice">없다</span>
                        </div>
                    </div>
                </div>
                ...
                <div id="result1_dp" style="display: none;">
                    <?php
                    $res1_choice = mysqli_query($db, "select choice from dp_select where boardnum = 11");
                    $row1_choice = mysqli_fetch_row($res1_choice);
                    $res1_red_num = mysqli_query($db, "select * from dp_select where boardnum = 11 and choice = 'red'");
                    $res1_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 11 and choice = 'blue'");
                    ...
                    if ($red1_num >= $blue1_num) { ?>
                        ...
                        <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                            <strong><span class="result_choice_red" style="color: crimson;">존재한다 <?php echo $red1_num; ?> </span></strong> 
                            <strong><span class="opinion" id="reply1_button" type="button" style="text-align: center;">의견</span></strong>
                            <strong><span class="result_choice_blue" style="color: deepskyblue;">없다 <?php echo $blue1_num; ?></span></strong>
                        </div>
                    <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp2">
                        <h4> 핸드폰은 갤럭시다? 아이폰이다? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">갤럭시</span>
                                <span class="result_vote" id="result2_vote">결과보기</span>
                                <span class="result_choice">아이폰</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result2_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res2_choice = mysqli_query($db, "select choice from dp_select where boardnum = 12");
                        $row2_choice = mysqli_fetch_row($res2_choice);
                        $res2_red_num = mysqli_query($db, "select * from dp_select where boardnum = 12 and choice = 'red'");
                        $res2_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 12 and choice = 'blue'");
                        ...
                        if ($red2_num >= $blue2_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">갤럭시 <?php echo $red2_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply2_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">아이폰 <?php echo $blue2_num; ?></span></strong>
                            </div>
                        <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    ...
                    <div id="result3_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res3_choice = mysqli_query($db, "select choice from dp_select where boardnum = 13");
                        $row3_choice = mysqli_fetch_row($res3_choice);
                        $res3_red_num = mysqli_query($db, "select * from dp_select where boardnum = 13 and choice = 'red'");
                        $res3_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 13 and choice = 'blue'");
                        ...
                        if ($red3_num >= $blue3_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">존재한다<?php echo $red3_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply3_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">없다 <?php echo $blue3_num; ?></span></strong>
                            </div>
                        <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp4">
                        <h4> 음바페 VS 홀란드 음란대전 누가 더 우세한가? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">음바페</span>
                                <span class="result_vote" id="result4_vote">결과보기</span>
                                <span class="result_choice">홀란드</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result4_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res4_choice = mysqli_query($db, "select choice from dp_select where boardnum = 14");
                        $row4_choice = mysqli_fetch_row($res4_choice);
                        $res4_red_num = mysqli_query($db, "select * from dp_select where boardnum = 14 and choice = 'red'");
                        $res4_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 14 and choice = 'blue'");
                        ...
                        if ($red4_num >= $blue4_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">음바페 <?php echo $red4_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply4_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">홀란드 <?php echo $blue4_num; ?></span></strong>
                            </div>
                        <?php } 
                        elseif ($blue4_num >= $red4_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="change_left" type="submit" name="changetored">음바페 <?php echo $red4_num; ?></span></strong> 
                                <strong><span class="opinion" id="reply4_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;"> 홀란드 <?php echo $blue4_num; ?> </span></strong>
                            </div>
                        <?php } ?>
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp5">
                        <h4> 요즘 대세 SNS는 인스타인가 틱톡인가? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice" >인스타</span>
                                <span class="result_vote" id="result5_vote">결과보기</span>
                                <span class="result_choice">틱톡</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result5_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res5_choice = mysqli_query($db, "select choice from dp_select where boardnum = 15");
                        $row5_choice = mysqli_fetch_row($res5_choice);
                        $res5_red_num = mysqli_query($db, "select * from dp_select where boardnum = 15 and choice = 'red'");
                        $res5_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 15 and choice = 'blue'");
                        ...
                        if ($red5_num >= $blue5_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">인스타 <?php echo $red5_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply5_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">틱톡 <?php echo $blue5_num; ?></span></strong>
                            </div>
                        <?php } 
        ...
        <div class="page">
            <ul class="pagination modal">
                ...
                <li><a href="http://www.whatthinkkr.com/whatthink3.php" class="active num">3</a></li>
