...
<html>
    <head>
        ...
        <base href="http://www.whatthinkkr.com/whatthink_main.php">
    ...
    <body>
        ...
        <header>
            ...
            <h2 onClick="window.location.reload()">what do you think</h2>
        </header>
        <hr>
        <nav class="menu">
            <ul>
     ...
     crossorigin="anonymous"></script>
        ...
        <section class="mainsection">
            <div id="page">
                <script type="text/javascript">
                    function reply(reply_boardnum) {
                        var reply = document.getElementById("reply_boardnum");
                        if(reply.click) {
                ...
                <?php
                if (isset($user_nick)) {
                    $sql1 = "select boardnum from dp_select where boardnum = 1 and user_nick = '$user_nick'";
                    $res1 = mysqli_query($db, $sql1);
                    $row1 = mysqli_fetch_row($res1);
                    
                    if($row1[0] == 1) { ?>                       
                        <?php
                        $sql1_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 1";
                        $res1_choice = mysqli_query($db, $sql1_choice);
                        $row1_choice = mysqli_fetch_row($res1_choice);
                        $sql1_red_num = "select * from dp_select where boardnum = 1 and choice = 'red'";
                        $sql1_blue_num = "select * from dp_select where boardnum = 1 and choice = 'blue'";
                        ...
                        if ($row1_choice[0] == "red") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    ...
                                    <strong><span style="color: crimson; text-decoration:underline; cursor: default;">호날두 <?php echo $red1_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply1_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="메시 <?php echo $blue1_num; ?>"></input></strong>
                                </div>
                            </form>
                        ...
                        elseif ($row1_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="1">
                                    <strong><input class = "change_left" type="submit" name="changetored" value="호날두 <?php echo $red1_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply1_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 메시 <?php echo $blue1_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        <?php } ?>
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="1">
                                    <input type="hidden" name="main_page" value="main_page1">
                                    <input type="hidden" name="board_page" value="page1"></input>
                                    <strong><input class="red" type="submit" name="dp_red" value="호날두"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="메시"></strong>
                                </div>
                            </div>
                        </form>
                ...
                <div class="boardnum_reply" id="reply1_screen" style="display: none;" >
                    <fieldset id="reply1" class="reply" style="overflow: auto;">
                        ...
                        <div id="1">
                            <div id="rep1">
                            <?php // 댓글 본문
                                $sql1_reply = "SELECT * FROM reply WHERE reply_boardnum = '1' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql2 = "select boardnum from dp_select where boardnum = 2 and user_nick = '$user_nick'";
                    $res2 = mysqli_query($db, $sql2);
                    $row2 = mysqli_fetch_row($res2);
                    
                    if ($row2[0] == 2) { ?>                       
                        <?php
                        $sql2_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 2";
                        $res2_choice = mysqli_query($db, $sql2_choice);
                        $row2_choice = mysqli_fetch_row($res2_choice);
                        $sql2_red_num = "select * from dp_select where boardnum = 2 and choice = 'red'";
                        $sql2_blue_num = "select * from dp_select where boardnum = 2 and choice = 'blue'";
                        ...
                        if ($row2_choice[0] == "red") { ?>
                            <h4 class="dpt"> 세상에 바퀴와 문 중 더 많이 존재한다고 생각하는 것은? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    ...
                                    <strong><span style="color: crimson; text-decoration:underline;">바퀴 <?php echo $red2_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply2_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class = "change_right" type="submit" name="changetoblue" value="문 <?php echo $blue2_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row2_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="2">
                                    <strong><input class="change_left" type="submit" name="changetored" value="바퀴 <?php echo $red2_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply2_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 문 <?php echo $blue2_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="2">
                                    <strong><input class="red" type="submit" name="dp_red" value="바퀴"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="문"></strong>
                                </div>
                            </div>
                            <iframe name="main_page_iframe" style="display: none;"></iframe>
                        </form>
                ...
                <div class="boardnum_reply" id="reply2_screen" style="display: none;" >
                    <fieldset id="reply2" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply2_iframe">
                            <input type="hidden" name="reps" value="rep2">
                            <input type="hidden" name="reply_boardnum" value="2">
                        ...
                        <div id="2">
                            <div id="rep2">
                            <?php // 댓글 본문
                                $sql2_reply = "SELECT * FROM reply WHERE reply_boardnum = '2' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql3 = "select boardnum from dp_select where boardnum = 3 and user_nick = '$user_nick'";
                    $res3 = mysqli_query($db, $sql3);
                    $row3 = mysqli_fetch_row($res3);
                    
                    if ($row3[0] == 3) { ?>                       
                        <?php
                        $sql3_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 3";
                        $res3_choice = mysqli_query($db, $sql3_choice);
                        $row3_choice = mysqli_fetch_row($res3_choice);
                        $sql3_red_num = "select * from dp_select where boardnum = 3 and choice = 'red'";
                        $sql3_blue_num = "select * from dp_select where boardnum = 3 and choice = 'blue'";
                        ...
                        if ($row3_choice[0] == "red") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    ...
                                    <strong><span style="color: crimson; text-decoration:underline;">뼈 치킨 <?php echo $red3_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply3_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="순살 치킨 <?php echo $blue3_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row3_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="3">
                                    <strong><input class="change_left" type="submit" name="changetored" value="뼈 치킨 <?php echo $red3_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply3_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 순살 치킨 <?php echo $blue3_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="3">
                                    <strong><input class="red" type="submit" name="dp_red" value="뼈 치킨"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="순살 치킨"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply3_screen" style="display: none;" >
                    <fieldset id="reply3" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply3_iframe">
                            <input type="hidden" name="reply_boardnum" value="3">
                            <input type="hidden" name="reply_choice" value="<?php echo $row3_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep3">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="3">
                            <div id="rep3">
                            <?php // 댓글 본문
                                $sql3_reply = "SELECT * FROM reply WHERE reply_boardnum = '3' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql4 = "select boardnum from dp_select where boardnum = 4 and user_nick = '$user_nick'";
                    $res4 = mysqli_query($db, $sql4);
                    $row4 = mysqli_fetch_row($res4);
                    
                    if ($row4[0] == 4) { ?>                       
                        <?php
                        $sql4_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 4";
                        $res4_choice = mysqli_query($db, $sql4_choice);
                        $row4_choice = mysqli_fetch_row($res4_choice);
                        $sql4_red_num = "select * from dp_select where boardnum = 4 and choice = 'red'";
                        $sql4_blue_num = "select * from dp_select where boardnum = 4 and choice = 'blue'";
                        ...
                        if ($row4_choice[0] == "red") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="4">
                                    <strong><span style="color: crimson; text-decoration:underline;">민초단 <?php echo $red4_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply4_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="반민초단 <?php echo $blue4_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row4_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="4">
                                    <strong><input class="change_left" type="submit" name="changetored" value="민초단 <?php echo $red4_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply4_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 반민초단 <?php echo $blue4_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="4">
                                    <strong><input class="red" type="submit" name="dp_red" value="민초단"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="반민초단"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply4_screen" style="display: none;" >
                    <fieldset id="reply4" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply4_iframe">
                            <input type="hidden" name="reply_boardnum" value="4">
                            <input type="hidden" name="reply_choice" value="<?php echo $row4_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep4">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="4">
                            <div id="rep4">
                            <?php // 댓글 본문
                                $sql4_reply = "SELECT * FROM reply WHERE reply_boardnum = '4' ORDER BY reply.reply_no DESC LIMIT 100";
                ...
                <?php
                if (isset($user_nick)) {
                    $sql5 = "select boardnum from dp_select where boardnum = 5 and user_nick = '$user_nick'";
                    $res5 = mysqli_query($db, $sql5);
                    $row5 = mysqli_fetch_row($res5);
                    
                    if ($row5[0] == 5) { ?>                       
                        <?php
                        $sql5_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 5";
                        $res5_choice = mysqli_query($db, $sql5_choice);
                        $row5_choice = mysqli_fetch_row($res5_choice);
                        $sql5_red_num = "select * from dp_select where boardnum = 5 and choice = 'red'";
                        $sql5_blue_num = "select * from dp_select where boardnum = 5 and choice = 'blue'";
                        ...
                        if ($row5_choice[0] == "red") { ?>
                            <h4 class="dpt"> 연인과 연인의 동성친구와 함께 밥을 먹는 도중 연인의 동성친구의 깻잎을 떼어주는 것은? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    ...
                                    <strong><span style="color: crimson; text-decoration:underline;">상관없다 <?php echo $red5_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply5_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="절대 안된다 <?php echo $blue5_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row5_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="5">
                                    <strong><input class="change_left" type="submit" name="changetored" value="상관없다 <?php echo $red5_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply5_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 절대 안된다 <?php echo $blue5_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="5">
                                    <strong><input class="red" type="submit" name="dp_red" value="상관없다"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="절대 안된다"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply5_screen" style="display: none;" >
                    <fieldset id="reply5" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply5_iframe">
                            <input type="hidden" name="reply_boardnum" value="5">
                            <input type="hidden" name="reply_choice" value="<?php echo $row5_choice[0]; ?>">
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep5">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                        ...
                        <div id="5">
                            <div id="rep5">
                            <?php // 댓글 본문
                                $sql5_reply = "SELECT * FROM reply WHERE reply_boardnum = '5' ORDER BY reply.reply_no DESC LIMIT 100";
        ...
        <div class="page">
            <ul class="pagination modal">
                ...
                <li><a href="http://www.whatthinkkr.com/whatthink_main.php" class="active num">1</a></li>
