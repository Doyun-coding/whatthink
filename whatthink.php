...
<html>
    ...
    <body>
     ...
     crossorigin="anonymous"></script>
        ...
        <section class="mainsection">
            <div>
                <div id="dp1">
                    ...
                    <div class="ngraph">
                        <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                            <span class="result_choice">호날두</span>
                            <span class="result_vote" id="result1_vote">결과보기</span>
                            <span class="result_choice">메시</span>
                        </div>
                    </div>
                </div>
                ...
                <div id="result1_dp" style="display: none;">
                    <?php
                    $res1_choice = mysqli_query($db, "select choice from dp_select where boardnum = 1");
                    $row1_choice = mysqli_fetch_row($res1_choice);
                    $res1_red_num = mysqli_query($db, "select * from dp_select where boardnum = 1 and choice = 'red'");
                    $res1_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 1 and choice = 'blue'");
                    ...
                    if ($red1_num >= $blue1_num) { ?>
                        ...
                        <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                            <strong><span class="result_choice_red" style="color: crimson;">호날두 <?php echo $red1_num; ?> </span></strong> 
                            <strong><span class="opinion" id="reply1_button" type="button" style="text-align: center;">의견</span></strong>
                            <strong><span class="result_choice_blue" style="color: deepskyblue;">메시 <?php echo $blue1_num; ?></span></strong>
                        </div>
                    <?php } 
                                ...
                                while($row1_reply = mysqli_fetch_array($res1_reply)) { ?>
                                    ...
                                    background-color: #9C9393; <?php }?>">
                                        ...
                                        <div style="padding-top: 2px; padding-right: 6px; paddding-left: 1px; padding-bottom: 6px;">
                                            <span class="reply_agree" style="font-size: 12px;">인정 <?php echo $row1_reply['reply_like']; ?></span>
                                            <span class="reply_not_agree" style="font-size: 12px;" ><?php echo $row1_reply['reply_unlike']; ?> 노인정</span>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp2">
                        <h4> 세상에 바퀴와 문 중 더 많이 존재한다고 생각하는 것은? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">바퀴</span>
                                <span class="result_vote" id="result2_vote">결과보기</span>
                                <span class="result_choice">문</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result2_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res2_choice = mysqli_query($db, "select choice from dp_select where boardnum = 2");
                        $row2_choice = mysqli_fetch_row($res2_choice);
                        $res2_red_num = mysqli_query($db, "select * from dp_select where boardnum = 2 and choice = 'red'");
                        $res2_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 2 and choice = 'blue'");
                        ...
                        if ($red2_num >= $blue2_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">바퀴 <?php echo $red2_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply2_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">문 <?php echo $blue2_num; ?></span></strong>
                            </div>
                        <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp3">
                        ...
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">뼈 치킨</span>
                                <span class="result_vote" id="result3_vote">결과보기</span>
                                <span class="result_choice">순살 치킨</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result3_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res3_choice = mysqli_query($db, "select choice from dp_select where boardnum = 3");
                        $row3_choice = mysqli_fetch_row($res3_choice);
                        $res3_red_num = mysqli_query($db, "select * from dp_select where boardnum = 3 and choice = 'red'");
                        $res3_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 3 and choice = 'blue'");
                        ...
                        if ($red3_num >= $blue3_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">뼈 치킨 <?php echo $red3_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply3_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">순살 치킨 <?php echo $blue3_num; ?></span></strong>
                            </div>
                        <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp4">
                        ...
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">민초단</span>
                                <span class="result_vote" id="result4_vote">결과보기</span>
                                <span class="result_choice">반민초단</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result4_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res4_choice = mysqli_query($db, "select choice from dp_select where boardnum = 4");
                        $row4_choice = mysqli_fetch_row($res4_choice);
                        $res4_red_num = mysqli_query($db, "select * from dp_select where boardnum = 4 and choice = 'red'");
                        $res4_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 4 and choice = 'blue'");
                        ...
                        if ($red4_num >= $blue4_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">민초단 <?php echo $red4_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply4_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">반민초단 <?php echo $blue4_num; ?></span></strong>
                            </div>
                        <?php } 
                        elseif ($blue4_num >= $red4_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="change_left" type="submit" name="changetored">민초단 <?php echo $red4_num; ?></span></strong> 
                                <strong><span class="opinion" id="reply4_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;"> 반민초단 <?php echo $blue4_num; ?> </span></strong>
                            </div>
                        <?php } ?>
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp5">
                        <h4> 연인과 연인의 동성친구와 함께 밥을 먹는 도중 연인의 동성친구의 깻잎을 떼어주는 것은? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice" >상관없다</span>
                                <span class="result_vote" id="result5_vote">결과보기</span>
                                <span class="result_choice">절대 안된다</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result5_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res5_choice = mysqli_query($db, "select choice from dp_select where boardnum = 5");
                        $row5_choice = mysqli_fetch_row($res5_choice);
                        $res5_red_num = mysqli_query($db, "select * from dp_select where boardnum = 5 and choice = 'red'");
                        $res5_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 5 and choice = 'blue'");
                        ...
                        if ($red5_num >= $blue5_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">상관없다 <?php echo $red5_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply5_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">절대 안된다 <?php echo $blue5_num; ?></span></strong>
                            </div>
                        <?php } 
        ...
        <div class="page">
            <ul class="pagination modal">
                ...
                <li><a href="http://www.whatthinkkr.com/whatthink.php" class="active num">1</a></li>
                <li><a href="http://www.whatthinkkr.com/whatthink2.php" class="num">2</a></li>
     ...
     crossorigin="anonymous"></script>
            <span>광고 문의</span></br>
            <span>www.whatthinkcp@gmail.com</span>
        </div>
        <footer>
            <nav>
