     ...
     crossorigin="anonymous"></script>
        ...
        <section class="mainsection">
            <div>
                <div id="dp1">
                    ...
                    <div class="ngraph">
                        <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                            <span class="result_choice">고기패티</span>
                            <span class="result_vote" id="result1_vote">결과보기</span>
                            <span class="result_choice">치킨패티</span>
                        </div>
                    </div>
                </div>
                ...
                <div id="result1_dp" style="display: none;">
                    <?php
                    $res1_choice = mysqli_query($db, "select choice from dp_select where boardnum = 16");
                    $row1_choice = mysqli_fetch_row($res1_choice);
                    $res1_red_num = mysqli_query($db, "select * from dp_select where boardnum = 16 and choice = 'red'");
                    $res1_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 16 and choice = 'blue'");
                    ...
                    if ($red1_num >= $blue1_num) { ?>
                        ...
                        <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                            <strong><span class="result_choice_red" style="color: crimson;">고기패티 <?php echo $red1_num; ?> </span></strong> 
                            <strong><span class="opinion" id="reply1_button" type="button" style="text-align: center;">의견</span></strong>
                            <strong><span class="result_choice_blue" style="color: deepskyblue;">치킨패티 <?php echo $blue1_num; ?></span></strong>
                        </div>
                    <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp2">
                        <h4> 블루투스 논쟁, 애인 차에 이성인 직장 동료가 블루투스 연결해도 되는가? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">된다</span>
                                <span class="result_vote" id="result2_vote">결과보기</span>
                                <span class="result_choice">안 된다</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result2_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res2_choice = mysqli_query($db, "select choice from dp_select where boardnum = 17");
                        $row2_choice = mysqli_fetch_row($res2_choice);
                        $res2_red_num = mysqli_query($db, "select * from dp_select where boardnum = 17 and choice = 'red'");
                        $res2_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 17 and choice = 'blue'");
                        ...
                        if ($red2_num >= $blue2_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">된다 <?php echo $red2_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply2_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">안 된다 <?php echo $blue2_num; ?></span></strong>
                            </div>
                        <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp3">
                        <h4> 유튜브 쇼츠, 인스타 릴스 중 더 선호하는 것은? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">쇼츠</span>
                                <span class="result_vote" id="result3_vote">결과보기</span>
                                <span class="result_choice">릴스</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result3_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res3_choice = mysqli_query($db, "select choice from dp_select where boardnum = 18");
                        $row3_choice = mysqli_fetch_row($res3_choice);
                        $res3_red_num = mysqli_query($db, "select * from dp_select where boardnum = 18 and choice = 'red'");
                        $res3_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 18 and choice = 'blue'");
                        ...
                        if ($red3_num >= $blue3_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">쇼츠<?php echo $red3_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply3_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">릴스 <?php echo $blue3_num; ?></span></strong>
                            </div>
                        <?php } 
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp4">
                        <h4> 라면 끓일 때 면 먼저? 스프 먼저? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice">면</span>
                                <span class="result_vote" id="result4_vote">결과보기</span>
                                <span class="result_choice">스프</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result4_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res4_choice = mysqli_query($db, "select choice from dp_select where boardnum = 19");
                        $row4_choice = mysqli_fetch_row($res4_choice);
                        $res4_red_num = mysqli_query($db, "select * from dp_select where boardnum = 19 and choice = 'red'");
                        $res4_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 19 and choice = 'blue'");
                        ...
                        if ($red4_num >= $blue4_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">면 <?php echo $red4_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply4_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">스프 <?php echo $blue4_num; ?></span></strong>
                            </div>
                        <?php } 
                        elseif ($blue4_num >= $red4_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="change_left" type="submit" name="changetored">면 <?php echo $red4_num; ?></span></strong> 
                                <strong><span class="opinion" id="reply4_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;"> 스프 <?php echo $blue4_num; ?> </span></strong>
                            </div>
                        <?php } ?>
                ...
                <div class="dpt" style="padding-top: 80px;">
                    <div id="dp5">
                        <h4> 평생 한 계절로 살아야 한다면? </h4>
                        <div class="ngraph">
                            <div style="display: flex; justify-content: space-between; height: 50px; line-height: 50px;">
                                <span class="result_choice" >여름</span>
                                <span class="result_vote" id="result5_vote">결과보기</span>
                                <span class="result_choice">겨울</span>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
                    ...
                    <div id="result5_dp" style="display: none; padding-top: 80px;">
                        <?php
                        $res5_choice = mysqli_query($db, "select choice from dp_select where boardnum = 20");
                        $row5_choice = mysqli_fetch_row($res5_choice);
                        $res5_red_num = mysqli_query($db, "select * from dp_select where boardnum = 20 and choice = 'red'");
                        $res5_blue_num = mysqli_query($db, "select * from dp_select where boardnum = 20 and choice = 'blue'");
                        ...
                        if ($red5_num >= $blue5_num) { ?>
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                <strong><span class="result_choice_red" style="color: crimson;">여름 <?php echo $red5_num; ?> </span></strong> 
                                <strong><span class="opinion" id="reply5_button" type="button" style="text-align: center;">의견</span></strong>
                                <strong><span class="result_choice_blue" style="color: deepskyblue;">겨울 <?php echo $blue5_num; ?></span></strong>
                            </div>
                        <?php } 
        ...
        <div class="page">
            <ul class="pagination modal">
                ...
                <li><a href="http://www.whatthinkkr.com/whatthink4.php" class="active num">4</a></li>
