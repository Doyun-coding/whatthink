     ...
     crossorigin="anonymous"></script>
        ...
        <section class="mainsection">
            <div id="page">
                ...
                <?php
                if (isset($user_nick)) {
                    $sql1 = "select boardnum from dp_select where boardnum = 6 and user_nick = '$user_nick'";
                    $res1 = mysqli_query($db, $sql1);
                    $row1 = mysqli_fetch_row($res1);
                    
                    if($row1[0] == 6) { ?>                       
                        <?php
                        $sql1_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 6";
                        $res1_choice = mysqli_query($db, $sql1_choice);
                        $row1_choice = mysqli_fetch_row($res1_choice);
                        $sql1_red_num = "select * from dp_select where boardnum = 6 and choice = 'red'";
                        $sql1_blue_num = "select * from dp_select where boardnum = 6 and choice = 'blue'";
                        ...
                        if ($row1_choice[0] == "red") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="6">
                                    <strong><span style="color: crimson; text-decoration:underline; cursor: default;">무한도전 <?php echo $red1_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply1_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="1박2일 <?php echo $blue1_num; ?>"></input></strong>
                                </div>
                            </form>
                        ...
                        elseif ($row1_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="6">
                                    <strong><input class = "change_left" type="submit" name="changetored" value="무한도전 <?php echo $red1_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply1_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 1박2일 <?php echo $blue1_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        <?php } ?>
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="6">
                                    <strong><input class="red" type="submit" name="dp_red" value="무한도전"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="1박2일"></strong>
                                </div>
                            </div>
                        </form>
                    ...
                    <fieldset id="reply1" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply_iframe">
                            ...
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep6">
                ...
                <?php
                if (isset($user_nick)) {
                    $sql2 = "select boardnum from dp_select where boardnum = 7 and user_nick = '$user_nick'";
                    $res2 = mysqli_query($db, $sql2);
                    $row2 = mysqli_fetch_row($res2);
                    
                    if ($row2[0] == 7) { ?>                       
                        <?php
                        $sql2_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 7";
                        $res2_choice = mysqli_query($db, $sql2_choice);
                        $row2_choice = mysqli_fetch_row($res2_choice);
                        $sql2_red_num = "select * from dp_select where boardnum = 7 and choice = 'red'";
                        $sql2_blue_num = "select * from dp_select where boardnum = 7 and choice = 'blue'";
                        ...
                        if ($row2_choice[0] == "red") { ?>
                            <h4 class="dpt"> 탕수육은 찍먹인가 부먹인가? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="7">
                                    <strong><span style="color: crimson; text-decoration:underline;">찍먹 <?php echo $red2_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply2_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="부먹 <?php echo $blue2_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row2_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="7">
                                    <strong><input class="change_left" type="submit" name="changetored" value="찍먹 <?php echo $red2_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply2_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 부먹 <?php echo $blue2_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="7">
                                    <strong><input class="red" type="submit" name="dp_red" value="찍먹"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="부먹"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply2_screen" style="display: none;" >
                    <fieldset id="reply2" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply2_iframe">
                            ...
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep7">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                ...
                <?php
                if (isset($user_nick)) {
                    $sql3 = "select boardnum from dp_select where boardnum = 8 and user_nick = '$user_nick'";
                    $res3 = mysqli_query($db, $sql3);
                    $row3 = mysqli_fetch_row($res3);
                    
                    if ($row3[0] == 8) { ?>                       
                        <?php
                        $sql3_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 8";
                        $res3_choice = mysqli_query($db, $sql3_choice);
                        $row3_choice = mysqli_fetch_row($res3_choice);
                        $sql3_red_num = "select * from dp_select where boardnum = 8 and choice = 'red'";
                        $sql3_blue_num = "select * from dp_select where boardnum = 8 and choice = 'blue'";
                        ...
                        if ($row3_choice[0] == "red") { ?>
                            <h4 class="dpt"> 이성친구간 친구는 가능한가? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="8">
                                    <strong><span style="color: crimson; text-decoration:underline;">가능하다 <?php echo $red3_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply3_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="불가능하다 <?php echo $blue3_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row3_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="8">
                                    <strong><input class="change_left" type="submit" name="changetored" value="가능하다 <?php echo $red3_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply3_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 불가능하다 <?php echo $blue3_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="8">
                                    <strong><input class="red" type="submit" name="dp_red" value="가능하다"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="불가능하다"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply3_screen" style="display: none;" >
                    <fieldset id="reply3" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply3_iframe">
                            ...
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep8">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                ...
                <?php
                if (isset($user_nick)) {
                    $sql4 = "select boardnum from dp_select where boardnum = 9 and user_nick = '$user_nick'";
                    $res4 = mysqli_query($db, $sql4);
                    $row4 = mysqli_fetch_row($res4);
                    
                    if ($row4[0] == 9) { ?>                       
                        <?php
                        $sql4_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 9";
                        $res4_choice = mysqli_query($db, $sql4_choice);
                        $row4_choice = mysqli_fetch_row($res4_choice);
                        $sql4_red_num = "select * from dp_select where boardnum = 9 and choice = 'red'";
                        $sql4_blue_num = "select * from dp_select where boardnum = 9 and choice = 'blue'";
                        ...
                        if ($row4_choice[0] == "red") { ?>
                            <h4 class="dpt"> 붕어빵을 먹을 때 머리부터? 꼬리부터? </h4>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="9">
                                    <strong><span style="color: crimson; text-decoration:underline;">머리 <?php echo $red4_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply4_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="꼬리 <?php echo $blue4_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row4_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="9">
                                    <strong><input class="change_left" type="submit" name="changetored" value="머리 <?php echo $red4_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply4_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 꼬리 <?php echo $blue4_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="9">
                                    <strong><input class="red" type="submit" name="dp_red" value="머리"></strong>
                                    <strong><input class="blue" type="submit" name="dp_blue" value="꼬리"></strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply4_screen" style="display: none;" >
                    <fieldset id="reply4" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply4_iframe">
                            ...
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep9">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
                ...
                <?php
                if (isset($user_nick)) {
                    $sql5 = "select boardnum from dp_select where boardnum = 10 and user_nick = '$user_nick'";
                    $res5 = mysqli_query($db, $sql5);
                    $row5 = mysqli_fetch_row($res5);
                    
                    if ($row5[0] == 10) { ?>                       
                        <?php
                        $sql5_choice = "select choice from dp_select where user_nick = '$user_nick' and boardnum = 10";
                        $res5_choice = mysqli_query($db, $sql5_choice);
                        $row5_choice = mysqli_fetch_row($res5_choice);
                        $sql5_red_num = "select * from dp_select where boardnum = 10 and choice = 'red'";
                        $sql5_blue_num = "select * from dp_select where boardnum = 10 and choice = 'blue'";
                        ...
                        if ($row5_choice[0] == "red") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="10">
                                    <strong><span style="color: crimson; text-decoration:underline;">환승이별 <?php echo $red5_num; ?> </span></strong> 
                                    <strong><input class="opinion" id="reply5_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><input class="change_right" type="submit" name="changetoblue" value="잠수이별 <?php echo $blue5_num; ?>"></input></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                        ...
                        <?php } elseif ($row5_choice[0] == "blue") { ?>
                            ...
                            <form action="change_opinion.php" method="post" target="main_opinion_iframe">
                                <div style="display: flex; justify-content: space-between; padding-top: 10px;">
                                    <input type="hidden" name="boardnum" value="10">
                                    <strong><input class="change_left" type="submit" name="changetored" value="환승이별 <?php echo $red5_num; ?>"> </input></strong> 
                                    <strong><input class="opinion" id="reply5_button" type="button" value="의견" style="text-align: center;"></input></strong>
                                    <strong><span style="color: deepskyblue; text-decoration:underline;"> 잠수이별 <?php echo $blue5_num; ?> </span></strong>
                                </div>
                            </form>
                            <iframe name="main_opinion_iframe" style="display: none;"></iframe>
                    ...
                    <?php }
                        ...
                        <form action="main_server.php" method="post" target="main_page_iframe">
                            ...
                            <div class="ngraph">
                                <div style="display: flex; justify-content: space-between; height: 40px; line-height: 50px;">
                                    <input type="hidden" name="boardnum" value="10">
                                    <strong> <input class="red" type="submit" name="dp_red" value="환승이별"> </strong>
                                    <strong> <input class="blue" type="submit" name="dp_blue" value="잠수이별"> </strong>
                                </div>
                            </div>
                        </form>
                        <iframe name="main_page_iframe" style="display: none;"></iframe>
                ...
                <div class="boardnum_reply" id="reply5_screen" style="display: none;" >
                    <fieldset id="reply5" class="reply" style="overflow: auto;">
                        <form action="reply_menu.php" method="post" target="reply5_iframe">
                            ...
                            <div class="reply_menu">
                                <input type="hidden" name="reps" value="rep10">
                                <input class="reply_menu_button" type="submit" name="reply_sup" value="지지순"></input>
                                <input class="reply_menu_button" type="submit" name="reply_new" value="최신순"></input>
        ...
        <div class="page">
            <ul class="pagination modal">
                ...
                <li><a href="http://www.whatthinkkr.com/whatthink_main2.php" class="active num">2</a></li>
